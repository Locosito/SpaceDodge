...
public class manageResultDuo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Newnum = PlayerPrefs.GetInt("micoD") + PlayerPrefs.GetInt("segD")*10 + PlayerPrefs.GetInt("min1D")*100 + PlayerPrefs.GetInt("min2D")*1000;

        if (PlayerPrefs.GetInt("PrimeroD") != 0)
        {
            Fnum = PlayerPrefs.GetInt("PrimeroD");
            Snum = PlayerPrefs.GetInt("SegundoD");
            Tnum = PlayerPrefs.GetInt("TerceroD");
            Fonum = PlayerPrefs.GetInt("CuartoD");
            Finum = PlayerPrefs.GetInt("QuintoD");
        }
    ...
    public void menu()
    {
        ...
        player2.muerte = false;
        PlayerSolo.muerte = false;
        PlayerPrefs.SetInt("PrimeroD", score[0]);
        PlayerPrefs.SetInt("SegundoD", score[1]);
        PlayerPrefs.SetInt("TerceroD", score[2]);
        PlayerPrefs.SetInt("CuartoD", score[3]);
        PlayerPrefs.SetInt("QuintoD", score[4]);
